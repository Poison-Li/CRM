...
function prase_xml(data1) {
    ...
    for (i = 0; i < data.length; i++) {
        ...
        item_customer['price'] = xmlDoc.getElementsByTagName('price')[0].childNodes[0].nodeValue;
        item_customer['remark'] = xmlDoc.getElementsByTagName('remark')[0].childNodes[0].nodeValue;
